...
var Register =
{
    ...
    function(label, type_list)
    {
        ...
        else if (label + 'Bean' in Register.atoms)
        {
            type_list.push(label + 'Bean');
            return type_list;
        }
        else
        {
...
class StringBean extends BaseType
{
    is_instance_of(an_object)
    {
...
register_atom("String", StringBean);


class Base64 extends StringBean
{
}
